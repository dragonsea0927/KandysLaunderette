...
const FAQCardTwo: FunctionComponent<IProps> = ({title, paragraph}) => {
	...
	function isParagraphContent(isParagraphContent: string) {
		...
		if (isParagraphContent === null || isParagraphContent === undefined) {
			contentStyling =
				"hidden mb-5 text-darkGrey font-medium leading-relaxed font-[400]";
		} else {
			contentStyling =
				"block mb-5 text-darkGrey font-medium leading-relaxed font-[400]";
		}
