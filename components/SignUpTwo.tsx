...
const SignUpTwo: FunctionComponent<IProps> = ({
	title,
	image,
	titleTwo,
	paragraph,
			...
			<div className="grid grid-cols-1 lg:grid-cols-2">
					...
					<div className="relative">
						<div className="w-full max-w-xl xl:w-full xl:mx-auto xl:pr-24 xl:max-w-2xl">
							...
							>
								...
								>
									<div className="inline-flex items-center justify-center flex-shrink-0 w-5 h-5 rounded-full bg-pink">
										<svg
									...
									<span className="text-white text-medium">{pointOne}</span>
								</motion.li>
								<motion.li
									variants={fadeInUp}
									className="flex items-center space-x-3"
								>
									...
									<span className="text-white text-medium">{pointTwo}</span>
								</motion.li>
								<motion.li
									variants={fadeInUp}
									className="flex items-center space-x-3"
								>
									...
									<span className="text-white text-medium">{pointThree}</span>
								</motion.li>
								<motion.li
									variants={fadeInUp}
									className="flex items-center space-x-3"
								>
									...
									<span className="text-white text-medium">{pointFour}</span>
								</motion.li>
							</motion.ul>
						</div>
					</div>
				...
				<div className="flex items-center justify-center px-4 py-10 bg-white sm:px-6 lg:px-8 sm:py-16 lg:py-24">
					<div className="xl:w-full xl:max-w-sm 2xl:max-w-md xl:mx-auto">
						...
						<p className="mt-2 text-base text-center text-darkGrey lg:text-left">
							Already have an account?
							<Link
								href="/Login"
								className="font-medium text-pink px-2 transition-all ease-in-out duration-[0.5s] hover:text-yellow focus:text-yellow hover:underline"
							>
								Login
							</Link>
						</p>
								...
								<div>
									...
									<div className="mt-2.5 relative text-darkGrey focus-within:text-darkGrey">
										...
										<input
											...
											className="block w-full py-4 pl-10 pr-4 text-black placeholder-darkGrey transition-all ease-in-out duration-[0.5s] border border-darkGrey rounded-lg bg-white  focus:border-pink focus:bg-white caret-pink"
										/>
									</div>
								</div>
						...
						<div className="mt-3 space-y-3">
							<button
								type="button"
								className="relative inline-flex items-center justify-center w-full px-4 py-4 text-base font-[600] text-darkGrey transition-all ease-in-out duration-[0.5s] bg-white border-2 border-darkGrey rounded-lg hover:text-pink hover:border-pink focus:text-pink "
							>
								...
								<Link href={`/Login`} className="font-[400] hover:text-pink">
									Sign up with Google
								</Link>
							</button>
