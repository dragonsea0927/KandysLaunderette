...
const HeroContentSection = (props) => {
	return (
		<section className="mt-24 pt-6 pb-20 bg-white overflow-hidden">
					...
					<div className="relative px-8 pt-20">
						<div className="md:max-w-2xl text-center mx-auto">
							...
							<p className="mb-10 text-base lg:text-medium text-center font-[400] text-black">
								...
								process to make sure the quality of wash and Iron. For laundry,
								Dry cleaning or Ironing, we are the most reliable company in
								your area.
							</p>
