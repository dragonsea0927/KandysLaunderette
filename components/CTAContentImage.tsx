...
const CTAContentImage: FunctionComponent<IProps> = ({
	title,
	image,
	paragraph,
	subtitleOne,
					...
					<div className="w-full md:w-1/2">
						...
						>
							<Link
								...
								className="py-4 px-8 font-[700] text-white text-base bg-pink rounded-lg hover:bg-yellow transition-all ease-in-out duration-[0.5s]"
							>
								{buttonLink?.title}
							</Link>
						</motion.div>
						<div className="flex flex-col sm:flex-row justify-center items-center gap-4 lg:gap-8">
							<div className="w-full md:w-1/2 p-0 lg:p-8">
								<div className="md:max-w-xs flex flex-col justify-center items-center lg:items-baseline">
									...
									<div
										className={isParagraphContent(paragraphOne)}
