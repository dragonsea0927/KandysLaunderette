					...
					<div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
						<div className="max-w-2xl mx-auto text-center">
							<div className="flex items-center justify-center">
								<div className="w-20 h-20 -mr-6 overflow-hidden rounded-full bg-grey">
									<Image
										width={550}
										height={550}
								...
								<div className="relative overflow-hidden border-8 border-white rounded-full bg-grey w-28 h-28">
									<Image
										width={550}
										height={550}
										className="object-cover w-full h-full"
								...
								<div className="w-20 h-20 -ml-6 overflow-hidden rounded-full bg-grey">
									<Image
										className="object-cover w-full h-full"
							...
							<h2 className="font-[800] text-2xl sm:text-3xl lg:text-5xl pt-4">
...
export async function getStaticProps() {
	const getPricesPageContent: any = gql`
		{
