		...
		>
			...
			<main>
				...
				<ContactFormMap
					...
					buttonLink={SustainabilityPageContent?.contactUs?.buttonLink}
					paragraphTwo={SustainabilityPageContent?.contactUs?.paragraphBottom}
				/>
			</main>
...
export async function getStaticProps() {
	const getSustainabilityPageContent = gql`
		{
